...
| 機場交通 | 鐘路3街 → 地鐵1號線 → 首爾站（3 站 7 分鐘）→ AREX 機場快線（43 分鐘） |
...
| 21:15 | 首爾站 → 鐘路3街站 | 地鐵1號線（3 站，約 7 分鐘） |
| 21:30 | Check-in M&LUCKY HOTEL、放行李 | — |
...
| 明洞旗艦店 | 중구 명동8나길 25（⚠️ Google 列表資料與誠信女大店混用） | [5.0⭐️(6)](https://www.google.com/maps/search/?api=1&query=명동8나길+25) |
